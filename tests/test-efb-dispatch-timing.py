...
assert bootstrap.index('apply_patch_once "$ref/ModernGekko/vendor/dolphin" "$efb_dispatch_patch"') < bootstrap.index('verify_patch_scope "$ref/ModernGekko/vendor/dolphin" "DolRecomp"')
program = r'''
#include "timing.h"
#include <cassert>
#include <bit>
