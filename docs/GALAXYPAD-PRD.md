...
Companion document: `docs/GALAXYPAD-GOAL-LOOP.md` (the operating loop). Read both documents before changing source, installing dependencies, extracting the disc, or launching a target.
